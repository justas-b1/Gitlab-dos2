...
parser.add_argument("--domain", required=True, help="GitLab Instance Domain (e.g., https://gitlab.example.com)")
parser.add_argument("--threads", type=int, default=99, help="Total number of concurrent threads")
parser.add_argument("--delay", type=float, default=1.0, help="Delay between thread starts in seconds")
parser.add_argument("--batch-delay", type=float, default=7.0, help="Delay after each batch of threads in seconds")
parser.add_argument("--batch-size", type=int, default=7, help="Number of threads in a batch before applying batch delay")
